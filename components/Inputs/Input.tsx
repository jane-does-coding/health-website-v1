	...
	return (
		<div className="w-full relative my-1">
			<input
				...
				type={type}
				minLength={3}
				className={`peer w-full p-3 pt-6 pl-4 font-light bg-neutral-300/75 border-2 border-neutral-400/75 text-black rounded-[2vh] outline-none transition disabled:opacity-70 disabled:cursor-not-allowed relative
